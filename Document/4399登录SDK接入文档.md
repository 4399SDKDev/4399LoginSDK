...
class SDKResult {
        ...
        // 游戏盒授权登录模式 uid
        public String geUID();
        // 获取第三方昵称，SDK 版本1.3.0或更高，若使用游戏盒授权登录，游戏盒版本应是5.5或以上
        public String geUID();
}
```
...
客户端段登录得到code或者token，还需要接入方接入服务端接口以获取完整的用户信息
...
从SDK 1.3.0版本开始，Web登录也返回`refresh_token`，即与游戏盒授权登录相同，用户信息*获取方式也相同，参考下文
